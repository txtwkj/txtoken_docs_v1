...
description: FluentRead 教程 — 开源浏览器翻译插件，支持 20+ 翻译引擎与 AI 大模型翻译。对接 天下同网 实现沉浸式双语阅读体验。
---
...
当浏览器安装了流畅阅读插件后，打开 天下同网 控制台->令牌管理页面会弹出添加流畅阅读的提示
